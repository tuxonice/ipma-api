...
class TotalDailyPrecipitation
{
    private const END_POINT = 'https://api.ipma.pt/open-data/observation/climate/precipitation-total/{district}/mrrto-{DICO}-{municipality}.csv';
