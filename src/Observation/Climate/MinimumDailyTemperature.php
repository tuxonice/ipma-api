...
class MinimumDailyTemperature
{
    private const END_POINT = 'https://api.ipma.pt/open-data/observation/climate/temperature-min/{district}/mtxmn-{DICO}-{municipality}.csv';
