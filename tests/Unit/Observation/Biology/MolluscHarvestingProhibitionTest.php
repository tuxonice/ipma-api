...
{
    private array $molluscHarvestingProhibition;
    ...
    protected function setUp(): void
    {
        ...
        $this->molluscHarvestingProhibition = json_decode($contents, true);
    }

    private function createService(): MolluscHarvestingProhibition
    {
    ...
    {
        $molluscHarvestingProhibition = $this->createService();
